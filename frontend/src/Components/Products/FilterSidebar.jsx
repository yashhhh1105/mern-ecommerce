  ...
  return (
    <div className='p-4'>
        ...
        <div className='mb-6'>
            ...
            <div className='flex flex-wrap gap-2'>
                {colors.map((color) => (
                    ...
                    transition hover:scale-105${filters.color === color ? "ring-2 ring-blue-500" :""}`} style={{backgroundColor: color.toLowerCase()}}>
                    </button>
                ))}
            </div>
        </div>
        ...
        <div className='mb-8'>
            ...
            className='w-full h-2 bg-gray-300 roundeed-lg appearance-none cursor-pointer'/>
